# https://github.com/m-bain/frozen-in-time/blob/main/parse_config.py
...
def setup_logging(save_dir, log_config='models/frozen_in_time/logger_config.json', default_level=logging.INFO):
    """
